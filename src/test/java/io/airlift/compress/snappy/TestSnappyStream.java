...
public class TestSnappyStream
{
    ...
    {
        TestSnappyLegacy.RandomGenerator gen = new TestSnappyLegacy.RandomGenerator(compressionRatio);
            ...
            throws Exception
    {
        ...
        InputStream in = new SnappyInputStream(new ByteArrayInputStream(compressed), true);
        int i = 0;
        int c;
        while ((c = in.read()) != -1) {
    ...
    public void testByteForByteTestData()
            throws Exception
    {
        for (File testFile : TestSnappyLegacy.getTestFiles()) {
            ...
            throws Exception
    {
        ...
        InputStream snappyIn = new SnappyInputStream(new ByteArrayInputStream(compressed), true);
            ...
            throws IOException
    {
        ...
        ByteArrayOutputStream out = new ByteArrayOutputStream();
        OutputStream os = new SnappyOutputStream(out);
