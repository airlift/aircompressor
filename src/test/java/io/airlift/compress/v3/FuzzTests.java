...
public class FuzzTests
{
    ...
    static
    {
        if (BLOCK_ALGORITHMS.length != BLOCK_ALGORITHMS_NUMBER) {
            throw new AssertionError("BLOCK_ALGORITHMS.length != BLOCK_ALGORITHMS_NUMBER");
        }
    }
    ...
    public void fuzzBlockDecompressMismatch(@InRange(min = 0, max = BLOCK_ALGORITHMS_NUMBER - 1) int algId, byte @NotNull @WithLength(min = 1, max = 10) [] input)
    {
        ...
        catch (IllegalArgumentException | IllegalStateException | MalformedInputException | IndexOutOfBoundsException ignored) {
        }
    ...
    static
    {
        if (AIRCOMPRESSOR_ALGORITHMS.length != AIRCOMPRESSOR_ALGORITHMS_NUMBER) {
            throw new AssertionError("AIRCOMPRESSOR_ALGORITHMS.length != AIRCOMPRESSOR_ALGORITHMS_NUMBER");
        }
    }
    ...
    public void fuzzAircompressorDecompress(@InRange(min = 0, max = AIRCOMPRESSOR_ALGORITHMS_NUMBER - 1) int algId, byte @NotNull [] input)
    {
        ...
        catch (IOException | IllegalArgumentException | MalformedInputException | IllegalStateException ignored) {
        }
    }
    ...
    public void fuzzDecompressionBomb(FuzzedDataProvider fdp)
    {
        ...
        catch (IOException | IllegalArgumentException | MalformedInputException | NegativeArraySizeException | IndexOutOfBoundsException | IllegalStateException | ArithmeticException ignored) {
        }
    }
