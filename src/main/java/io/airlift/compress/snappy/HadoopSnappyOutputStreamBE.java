...
class HadoopSnappyOutputStreamBE
        extends CompressionOutputStream
{
    private final SnappyCompressorBE compressor = new SnappyCompressorBE();
    ...
    public HadoopSnappyOutputStreamBE(OutputStream out, int bufferSize)
    {
        super(out);
