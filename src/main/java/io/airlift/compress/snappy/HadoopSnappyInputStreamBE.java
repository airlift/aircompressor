...
class HadoopSnappyInputStreamBE
        extends CompressionInputStream
{
    private final SnappyDecompressorBE decompressor = new SnappyDecompressorBE();
    ...
    public HadoopSnappyInputStreamBE(InputStream in)
            throws IOException
    {
        super(in);
        this.in = in;
