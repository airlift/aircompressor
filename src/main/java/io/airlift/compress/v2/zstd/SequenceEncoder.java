...
import static io.airlift.compress.v2.zstd.Constants.MAX_OFFSET_CODE_SYMBOL;
...
import static io.airlift.compress.v2.zstd.FiniteStateEntropy.optimalTableLog;
import static io.airlift.compress.v2.zstd.UnsafeUtil.UNSAFE;
import static io.airlift.compress.v2.zstd.Util.checkArgument;
