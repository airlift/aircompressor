...
import static io.airlift.compress.v2.zstd.BitInputStream.peekBits;
import static io.airlift.compress.v2.zstd.Constants.COMPRESSED_BLOCK;
import static io.airlift.compress.v2.zstd.Constants.COMPRESSED_LITERALS_BLOCK;
import static io.airlift.compress.v2.zstd.Constants.DEFAULT_MAX_OFFSET_CODE_SYMBOL;
import static io.airlift.compress.v2.zstd.Constants.LITERALS_LENGTH_BITS;
import static io.airlift.compress.v2.zstd.Constants.LITERAL_LENGTH_TABLE_LOG;
import static io.airlift.compress.v2.zstd.Constants.LONG_NUMBER_OF_SEQUENCES;
import static io.airlift.compress.v2.zstd.Constants.MAGIC_NUMBER;
import static io.airlift.compress.v2.zstd.Constants.MATCH_LENGTH_BITS;
import static io.airlift.compress.v2.zstd.Constants.MATCH_LENGTH_TABLE_LOG;
import static io.airlift.compress.v2.zstd.Constants.MAX_BLOCK_SIZE;
import static io.airlift.compress.v2.zstd.Constants.MAX_LITERALS_LENGTH_SYMBOL;
import static io.airlift.compress.v2.zstd.Constants.MAX_MATCH_LENGTH_SYMBOL;
import static io.airlift.compress.v2.zstd.Constants.MIN_BLOCK_SIZE;
import static io.airlift.compress.v2.zstd.Constants.MIN_SEQUENCES_SIZE;
import static io.airlift.compress.v2.zstd.Constants.MIN_WINDOW_LOG;
import static io.airlift.compress.v2.zstd.Constants.OFFSET_TABLE_LOG;
import static io.airlift.compress.v2.zstd.Constants.RAW_BLOCK;
import static io.airlift.compress.v2.zstd.Constants.RAW_LITERALS_BLOCK;
import static io.airlift.compress.v2.zstd.Constants.RLE_BLOCK;
import static io.airlift.compress.v2.zstd.Constants.RLE_LITERALS_BLOCK;
import static io.airlift.compress.v2.zstd.Constants.SEQUENCE_ENCODING_BASIC;
import static io.airlift.compress.v2.zstd.Constants.SEQUENCE_ENCODING_COMPRESSED;
import static io.airlift.compress.v2.zstd.Constants.SEQUENCE_ENCODING_REPEAT;
import static io.airlift.compress.v2.zstd.Constants.SEQUENCE_ENCODING_RLE;
import static io.airlift.compress.v2.zstd.Constants.SIZE_OF_BLOCK_HEADER;
import static io.airlift.compress.v2.zstd.Constants.SIZE_OF_BYTE;
import static io.airlift.compress.v2.zstd.Constants.SIZE_OF_INT;
import static io.airlift.compress.v2.zstd.Constants.SIZE_OF_LONG;
import static io.airlift.compress.v2.zstd.Constants.SIZE_OF_SHORT;
import static io.airlift.compress.v2.zstd.Constants.TREELESS_LITERALS_BLOCK;
import static io.airlift.compress.v2.zstd.UnsafeUtil.UNSAFE;
import static io.airlift.compress.v2.zstd.Util.fail;
import static io.airlift.compress.v2.zstd.Util.get24BitLittleEndian;
import static io.airlift.compress.v2.zstd.Util.mask;
import static io.airlift.compress.v2.zstd.Util.verify;
