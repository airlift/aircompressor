...
import static io.airlift.compress.v2.zstd.FiniteStateEntropy.MAX_SYMBOL;
import static io.airlift.compress.v2.zstd.FiniteStateEntropy.MIN_TABLE_LOG;
import static io.airlift.compress.v2.zstd.UnsafeUtil.UNSAFE;
import static io.airlift.compress.v2.zstd.Util.highestBit;
