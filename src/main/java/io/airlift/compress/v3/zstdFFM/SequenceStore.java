...
final class SequenceStore
{
    ...
    public final MemorySegment literalsBufferSegment;
    ...
    {
        MemorySegment.copy(inputBase, inputAddress, literalsBufferSegment, literalsLength, inputSize);
    ...
    public void storeSequence(MemorySegment literalBase, long literalAddress, int literalLength, int offsetCode, int matchLengthBase)
    {
        ...
        int copied = 0;
        do {
            literalsBufferSegment.set(JAVA_LONG, output, literalBase.get(JAVA_LONG, input));
            input += SIZE_OF_LONG;
            output += SIZE_OF_LONG;
            copied += SIZE_OF_LONG;
        }
