        ...
        implements ZstdDecompressor
{
            ...
            throws MalformedInputException
    {
        ...
        return decompressor.decompress(MemorySegment.ofArray(input), inputOffset, inputLimit, MemorySegment.ofArray(output), outputOffset, outputLimit);
    }
    ...
    {
        return ZstdFrameDecompressor.getDecompressedSize(MemorySegment.ofArray(input), offset, (long) offset + length);
    }
